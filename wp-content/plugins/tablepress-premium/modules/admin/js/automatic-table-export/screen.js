 ...
 */
const AutomaticTableExportScreen = () => {
								...
								>
									...
									>
										<input
											...
											onChange={ ( event ) => {
												let newSelectedFormats = [ ...screenData.selectedFormats ];
												if ( event.target.checked ) {
													newSelectedFormats.push( event.target.value );
												} else {
													newSelectedFormats = newSelectedFormats.filter( ( format ) => ( format !== event.target.value ) );
												}
												updateScreenData( 'selectedFormats', newSelectedFormats );
											} }
										/> { exportFormatName }
									</label><br />
								</Fragment>
...
export default AutomaticTableExportScreen;
