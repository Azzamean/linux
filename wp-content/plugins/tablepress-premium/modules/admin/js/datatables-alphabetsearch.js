...
add_action( 'tablepress.optionsCheckDependencies', 'tp/datatables-alphabetsearch/handle-options-check-dependencies', () => {
	...
	$( '#option-datatables_alphabetsearch' ).disabled = ! alphabetsearch_enabled;
	$( '#notice-datatables-alphabetsearch-requirements' ).style.display = alphabetsearch_enabled ? 'none' : 'block';
	$( '#option-datatables_alphabetsearch_column' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch;
	$( '#option-datatables_alphabetsearch_alphabet-latin' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch;
	$( '#option-datatables_alphabetsearch_alphabet-greek' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch;
	$( '#option-datatables_alphabetsearch_numbers' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch;
	$( '#option-datatables_alphabetsearch_letters' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch;
	$( '#option-datatables_alphabetsearch_case_sensitive' ).disabled = ! alphabetsearch_enabled || ! tp.table.options.datatables_alphabetsearch || ! tp.table.options.datatables_alphabetsearch_letters;
} );
