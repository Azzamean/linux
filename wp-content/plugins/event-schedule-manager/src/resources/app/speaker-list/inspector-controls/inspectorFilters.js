...
export const useProcessedDisplayPanelRows = ( attributes, setAttributes ) => {
	/**
	 * Filter the panel rows for display options in the speaker list block inspector.
	 *
	 * @since 1.2.0
	 *
	 * @param {Array}  rows        The array of panel rows.
...
/**
 * Exported hook to get processed query panel rows.
 *
 * @since 1.2.0
 *
 * @param {Object} attributes   The block attributes.
 * @param {Object} setAttributes The function to update block attributes.
 *
 * @return {Array} The array of processed query panel rows.
 */
export const useProcessedQueryPanelRows = ( attributes, setAttributes ) => {
	/**
	 * Filter the panel rows for query and filtering options in the speaker list block inspector.
	 *
	 * @since 1.2.0
	 *
	 * @param {Array}  rows        The array of panel rows.
	 ...
	 * @param {Object} setAttributes The function to update block attributes.
	 *
	 * @return {Array} The modified array of panel rows for query and filtering options.
	 */
	const inspectorControlsQuery = applyFilters(
	...
	return processPanelRows( inspectorControlsQuery, attributes, setAttributes );
};
