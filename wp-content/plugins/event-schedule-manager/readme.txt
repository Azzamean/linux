...
* Feature - Add Speak List block [ESM-59]
* Feature - Add Sponsors block [ESM-60]
* Tweak - Add Event Schedule Manager block category and add event schedule, speaker list and sponsor block to it. [ESM-82]
* Tweak - Added filters: `tec_event_schedule_manager_speaker_list_block_query_url`, `tec_event_schedule_manager_sponsors_block_query_url`, `tec_schedule_manager_speakers_list_session_args`, `tec_event_schedule_manager_sponsors_by_term_query_args`, `tec_event_schedule_manager_sponsor_logo_height`, `tec_event_schedule_manager_sponsor_image_size`, `tec_event_schedule_manager_rest_openapi_documentation`, `tec_event_schedule_manager_speaker_list_rest_get_args`, `tec_event_schedule_manager_rest_speaker_list_data`, `tec_event_schedule_manager_sponsors_rest_get_args`, `tec_event_schedule_manager_rest_sponsors_data`, `rest_url_prefix`, `tec_event_schedule_manager_rest_url_prefix`, `tec_event_schedule_manager_rest_url`, `tec_event_schedule_manager_rest_use_builtin`
* Language - 102 new strings added, 1 updated, 0 fuzzied, and 0 obsoleted


= 1.1.1 2024-04-09 =

* Fix - Group parameter on the speaker list shortcode. [ESM-73]
* Fix - Sponsor level order when using [tec_sponsors] shortcode. [ESM-75]
* Fix - Utilize locale names for dates on single sessions and schedule shortcode. [ESM-78]
* Tweak - Displays sponsors with no sponsor level assigned in the [tec_sponsors] with include_unassigned attribute to control it. [ESM-67]
* Tweak - Added filters: `tec_schedule_manager_speakers_list_session_args`
