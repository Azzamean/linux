...
class jci_Cache {
	...
	public function getCacheFileName($feedUrl, $postPayload="", $postbody="", $curloptions=array()) {
		...
		if (is_array($curloptions)) {
			$curloptionsStr = implode ("#", $curloptions);
   			$cacheFile .= "-co".sanitize_file_name(md5($curloptionsStr));
		}
