...
class jci_widget_plugin extends WP_Widget {
	...
	private function jci_utf8_encode($string) { # v8.2: removed utf8_encode, deprecated in php 8.2
	...
	public function jci_showDebugMessage($debugMessage, $debugLevel=2, $suffix="") {
		...
		echo "<i>DEBUG: ";
		$dm = htmlentities($this->jci_utf8_encode($debugMessage), ENT_QUOTES, "UTF-8");
		if ($dm=="") {
			echo $debugMessage;
		} else {
			echo $dm;
...
class JsonContentImporterWidget {
   ...
   /* shortcodeExecute: read shortcode-params and check cache */
      ...
      if (class_exists( '/JCITwig/Twig_Autoloader' ) ) {
        ...
        $inc = WP_PLUGIN_DIR . '/jsoncontentimporterpro3/twiglib/twig351adj/vendor/autoloader.php'; 
