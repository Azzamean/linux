...
<article class="cm-shortcode-desc">
    ...
    <div class="cm-shortcode-desc-inner">
        ...
        <ul>
            ...
            <li><strong>link</strong> - URL where the term should link to.</li>
            <li><strong>term_id</strong> - ID of the Glossary Term post, which will be used for the tooltip content (using this ignores/overrides the "content" attribute)</li>
        </ul>
...
<article class="cm-shortcode-desc">
    ...
    'plugin-licensing-aliases'  => array( CMTT_LICENSE_NAME, 'CM Tooltip Glossary Pro Edition' ),
);
