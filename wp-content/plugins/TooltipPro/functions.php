...
if (!function_exists('cminds_amp_custom_css')) {

    /*
     * Add custom CSS for "AMP for WP" plugin
     */
    add_action('amp_post_template_css', 'cminds_amp_custom_css', 11);

    function cminds_amp_custom_css() {
        ...
        $tt_styles .= 'z-index:' . (int) \CM\CMTT_Settings::get('cmtt_tooltipZIndex', 1500) . ';';

        $ttcont_styles = '';
        $ttcont_styles .= 'border:' . \CM\CMTT_Settings::get('cmtt_tooltipBorderWidth') . 'px ' . \CM\CMTT_Settings::get('cmtt_tooltipBorderStyle') . \CM\CMTT_Settings::get('cmtt_tooltipBorderColor') . ';';
