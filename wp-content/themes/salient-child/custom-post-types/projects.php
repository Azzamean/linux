    ...
    acf_add_local_field_group([
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "wysiwyg",
                "instructions" =>
                    "Please enter the main description and content of the project",
                "required" => 0,
                "conditional_logic" => 0,
                "wrapper" => [
                    "width" => "",
            ...
            [
                "key" => "field_624df7e565126",
                "label" => "Use Logo Instead of Header Text",
                "name" => "use_logo_instead_of_header_text",
                "type" => "radio",
                "instructions" =>
                    "Would you like to use the Logo or White Logo instead of header text?",
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
                            "field" => "field_6209490a57fa5",
                            "operator" => "!=empty",
                        ],
                    ],
                    [
                        [
                            "field" => "field_620ad71772889",
                            "operator" => "!=empty",
                        ],
                    ],
                ],
            ...
            [
                ...
                "type" => "url",
                "instructions" =>
                    "Please enter the documentation link of the project",
                "required" => 0,
                "conditional_logic" => 0,
                "wrapper" => [
                    "width" => "50",
