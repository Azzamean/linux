...
add_action( 'acf/include_fields', function() {
	...
	'fields' => array(
		array(
			...
			'aria-label' => '',
			'type' => 'image',
			'instructions' => 'Please select the primary logo (this will be used on the posts display preview)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'image',
			'instructions' => 'Please select the secondary logo (this is an alternative logo used for the banner)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'image',
			'instructions' => 'Please select the projects banner background image',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'color_picker',
			'instructions' => 'Please select the projects banner background color',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '25',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'Please enter the projects excerpt (this will go on the banner and be used for posts display preview)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'oembed',
			'instructions' => 'Please enter the projects video link (if applicable)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'taxonomy',
			'instructions' => 'Please enter the projects category (this will link to recent posts with the selected category)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'taxonomy',
			'instructions' => 'Please enter the projects category (this will link to the projects selected category)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'instructions' => 'Please select to add an icon with a URL attached (the URL will be a clickable icon)',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
				...
				'layout_63a0d4bd47946' => array(
					...
					'sub_fields' => array(
						array(
							...
							'aria-label' => '',
							'type' => 'url',
							'instructions' => 'Please add a valid URL to your icon',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
						...
						array(
							...
							'aria-label' => '',
							'type' => 'font-awesome',
							'instructions' => 'Please note that the social media brands are in the bottom of the select box',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
						...
						array(
							...
							'aria-label' => '',
							'type' => 'text',
							'instructions' => 'Please give a name to your icon (this will appear below the icon itself)',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
		...
		array(
			...
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'Please enter a heading title for your description',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
				...
				'layout_647faf3ce73cd' => array(
					...
					'sub_fields' => array(
						array(
							...
							'aria-label' => '',
							'type' => 'image',
							'instructions' => 'Please enter an image for your case study',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
						...
						array(
							...
							'aria-label' => '',
							'type' => 'text',
							'instructions' => 'Please enter a title for your case study',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
