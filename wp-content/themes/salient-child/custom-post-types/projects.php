...
function cptui_register_my_cpts_projects()
{
    ...
    $labels = ["name" => __("Projects", "custom-post-type-ui") , "singular_name" => __("Project", "custom-post-type-ui") , ];

    $args = ["label" => __("Projects", "custom-post-type-ui") , "labels" => $labels, "description" => "", "public" => true, "publicly_queryable" => true, "show_ui" => true, "show_in_rest" => true, "rest_base" => "", "rest_controller_class" => "WP_REST_Posts_Controller", "has_archive" => false, "show_in_menu" => true, "show_in_nav_menus" => true, "delete_with_user" => false, "exclude_from_search" => false, "capability_type" => "post", "map_meta_cap" => true, "hierarchical" => false, "rewrite" => ["slug" => "projects/project", "with_front" => true], "query_var" => true, "menu_icon" => "dashicons-admin-page", "supports" => ["title", "editor", "author"], "taxonomies" => ["projects_category"], "show_in_graphql" => false, ];
...
function cptui_register_my_taxes_projects_category()
{
    ...
    $labels = ["name" => __("Projects Categories", "custom-post-type-ui") , "singular_name" => __("Project Category", "custom-post-type-ui") , ];

    $args = ["label" => __("Projects Categories", "custom-post-type-ui") , "labels" => $labels, "public" => true, "publicly_queryable" => true, "hierarchical" => true, "show_ui" => true, "show_in_menu" => true, "show_in_nav_menus" => true, "query_var" => true, "rewrite" => ["slug" => "projects_category", "with_front" => true], "show_admin_column" => true, "show_in_rest" => true, "show_tagcloud" => false, "rest_base" => "projects_category", "rest_controller_class" => "WP_REST_Terms_Controller", "show_in_quick_edit" => false, "show_in_graphql" => false, ];
...
function cptui_register_my_taxes_projects_stage()
{
    ...
    $labels = ["name" => __("Projects Stages", "custom-post-type-ui") , "singular_name" => __("Project Stage", "custom-post-type-ui") , ];

    $args = ["label" => __("Projects Stages", "custom-post-type-ui") , "labels" => $labels, "public" => true, "publicly_queryable" => true, "hierarchical" => true, "show_ui" => true, "show_in_menu" => true, "show_in_nav_menus" => true, "query_var" => true, "rewrite" => ["slug" => "projects_stage", "with_front" => true], "show_admin_column" => false, "show_in_rest" => true, "show_tagcloud" => false, "rest_base" => "projects_stage", "rest_controller_class" => "WP_REST_Terms_Controller", "show_in_quick_edit" => false, "show_in_graphql" => false, ];
...
if (function_exists('acf_add_local_field_group')):
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_621d283a5c703',
                'label' => 'Website',
                'name' => 'projects_website',
                'type' => 'url',
                'instructions' => 'Please enter the website of the project',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
            ...
            array(
                ...
                'type' => 'url',
                'instructions' => 'Please enter the documentation link of the project',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '50',
