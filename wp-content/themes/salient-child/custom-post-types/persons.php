<?php
function cptui_register_my_cpts_persons()
{
    /**
     * Post Type: Persons.
     */
    ...
    $args = array(
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => array("slug" => "persons", "with_front" => true),
        "query_var" => true,
...
add_action('vc_before_init', 'cptui_register_my_cpts_persons');

function cptui_register_my_taxes_person_type()
{
    /**
     * Taxonomy: Person Types.
     */

    $labels = array(
        "name" => __('Person Types', ''),
        "singular_name" => __('Person Type', '')
    );

    $args = array(
        "label" => __('Person Types', ''),
        "labels" => $labels,
        "public" => true,
        "hierarchical" => true,
        "label" => "Person Types",
        ...
        "query_var" => true,
        "rewrite" => array('slug' => 'person_type', 'with_front' => false),
    ...
    register_taxonomy("person_type", array("persons"), $args);
}

add_action('vc_before_init', 'cptui_register_my_taxes_person_type');

if (function_exists('acf_add_local_field_group')):
    acf_add_local_field_group(array(
        'key' => 'group_58ffa4b8b260f',
        'title' => 'Persons',
        'fields' => array(
            array(
                'key' => 'field_58ffa5080fefd',
                'label' => 'Job/Role',
                'name' => 'job',
                'type' => 'text',
                'instructions' => '',
