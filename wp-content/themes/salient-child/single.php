...
if (have_posts()):
    while (have_posts()):
        ...
        if ("image_under" !== $blog_header_type) {
            // LF Networking
            if ($site_id == "7") {
                get_template_part("includes/partials/single-post/post-header-style-one");
            }
            // LF Energy || LF Edge
            elseif ($site_id == "18" || $site_id == "24") {
                get_template_part("includes/partials/single-post/post-header-style-three");
            } else {
...
if (have_posts()):
    while (have_posts()):
        ...
        // LF Networking
        if ($site_id == "7") {
            get_template_part("includes/partials/single-post/post-content-style-one");
        }
        // OMP
        elseif ($site_id == "14") {
            get_template_part("includes/partials/single-post/post-content-style-two");
        }
        // LF Energy || LF Edge
        elseif ($site_id == "18" || $site_id == "24") {
            get_template_part("includes/partials/single-post/post-content-style-three");
        } else {
...
if (!empty($nectar_options["author_bio"]) && "1" === $nectar_options["author_bio"] && "ascend" === $theme_skin && "post" == get_post_type()) {
