...
// CREATE AND REGISTER CUSTOM POST TYPE PROJECTS
...
add_action("vc_before_init", "cpt_projects");

// REGISTER TAXONOMY FOR CUSTOM POST TYPE PROJECTS
function cpt_taxonomy_projects()
{
    $labels = [
    ...
    $args = [
        ...
        "query_var" => true,
        "rewrite" => ["slug" => "project_type", "with_front" => false],
...
add_action("vc_before_init", "cpt_taxonomy_projects");





// UTILIZE WITH ADVANCED CUSTOM FIELDS
