...
class RecentPostsLinux
{
    ...
    function recent_posts_vc_linux()
    {
        ...
        if (function_exists("vc_map")):
            vc_map(["name" => esc_html__("Recent Posts - Linux Foundation Designed", "recent_posts") , "base" => "recent_posts_basic", "icon" => "vc_element-icon icon-wpb-recent-posts", "class" => "", "category" => esc_html__("Linux Foundation", "recent_posts") , "description" => esc_html__("Display list of recent_posts custom post type", "recent_posts") , "params" => [["type" => "dropdown", "heading" => esc_html__("Design", "salient-core") , "param_name" => "design", "admin_label" => true, "value" => [esc_html__("Basic Design", //lfenergy
            "salient-core") => "basic-design", esc_html__("Grid Design", //interuss
            "salient-core") => "grid-design", esc_html__("Simple Grid Design", //lfaidata
            "salient-core") => "simple-grid-design", ], "save_always" => true, "description" => esc_html__("Please select the design you desire for your blog", "salient-core") , ], ["type" => "dropdown", "class" => "", "heading" => esc_html__("Columns", "recent_posts") , "param_name" => "columns", "value" => [esc_html__("2 Columns", "recent_posts") => "2", esc_html__("3 Columns", "recent_posts") => "3", esc_html__("4 Columns", "recent_posts") => "4", ], "dependency" => ["element" => "design", "value" => ["grid-design"], ], "description" => esc_html__("Please select the number of columns you want displayed", "salient-core") , "save_always" => true, ], ["type" => "dropdown_multi", "class" => "", "heading" => esc_html__("Recent Posts Categories", "recent_posts") , "param_name" => "category_id", "value" => $pt, "description" => esc_html__("", "recent_posts") , "save_always" => true, ], ["type" => "textfield", "class" => "", "heading" => esc_html__("Post Per Page", "recent_posts") , "param_name" => "limit", "value" => "10", "description" => esc_html__("Enter number of people to be displayed. Enter -1 to display all.", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Pagination", "recent_posts") , "param_name" => "pagination", "value" => [
            //esc_html__( 'Show Pagination', 'recent_posts' ) => 'show-pagination',
            esc_html__("Hide Pagination", "recent_posts") => "hide-pagination", ], "std" => "show-pagination", "description" => esc_html__("Check or uncheck the box if you want to show or hide pagination", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Featured Image", "recent_posts") , "param_name" => "featured_image", "value" => [esc_html__("Hide Featured Image", "recent_posts") => "hide-featured-image", ], "std" => "show-featured-image", "description" => esc_html__("Check or uncheck the box if you want to show or hide the featured image", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Categories", "recent_posts") , "param_name" => "categories", "value" => [esc_html__("Show Categories", "recent_posts") => "show-categories", ], "std" => "hide-categories", "description" => esc_html__("Check or uncheck the box if you want to show or hide categories", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Tags", "recent_posts") , "param_name" => "tags", "value" => [esc_html__("Show Tags", "recent_posts") => "show-tags", ], "std" => "hide-tags", "description" => esc_html__("Check or uncheck the box if you want to show or hide tags", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Read More Button", "recent_posts") , "param_name" => "read", "value" => [esc_html__("Show Read More Button", "recent_posts") => "show-read", ], "std" => "hide-read", "description" => esc_html__("Check or uncheck the box if you want to show or hide read more button", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Read More Link", "recent_posts") , "param_name" => "read_link", "value" => [esc_html__("Show Read More Link", "recent_posts") => "show_read_link", ], "std" => "hide_read_link", "description" => esc_html__("Check or uncheck the box if you want to show or hide read more link", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Date of Publication", "recent_posts") , "param_name" => "dop", "value" => [esc_html__("Remove Date of Publication", "recent_posts") => "hide-dop", ], "std" => "show-dop", "description" => esc_html__("Check or uncheck the box if you want to show or hide date of publication", "recent_posts") , "save_always" => true, ], ["type" => "checkbox", "class" => "", "heading" => esc_html__("Excerpt", "recent_posts") , "param_name" => "excerpt", "value" => [esc_html__("Remove Excerpt", "recent_posts") => "hide-excerpt", ], "std" => "show-excerpt", "description" => esc_html__("Check or uncheck the box if you want to show or hide the excerpt", "recent_posts") , "save_always" => true, ], ], ]);
        endif;
    }
}
...
function recent_posts_linux($atts, $content)
{
    ...
    extract(shortcode_atts(["limit" => "", "design" => "", "columns" => "", "category_id" => "", "pagination" => "", "featured_image" => "", "categories" => "", "tags" => "", "read" => "", "read_link" => "", "dop" => "", "excerpt" => "", "suppress_filters" => true, ], $atts));
    ...
    if ($recent_posts_query->have_posts())
    {
        ...
        while ($recent_posts_query->have_posts()):
            ...
            if ($design == "Basic Design")
            {
                ...
                {
                    $output .= " In " . get_the_category_list(", ") . get_the_tag_list(", ", ", ");
                }
                ...
                if ($read != false)
                {
                    $output .= '<a class="basic-design read" href=' . get_permalink() . "><span>Read More</span></a>";
                }
                $output .= "</div>";
                $output .= "</div>";
                $count++;
            ...
            if ($design == "Grid Design")
            {
                ...
                $output .= '<div class="grid-design header"><h3 class="grid-design title"><a href="' . get_permalink() . '">' . get_the_title() . "</a></h3>";
                if ($dop == true)
                {
            ...
            if ($design == "Simple Grid Design")
            {
                ...
                $output .= '<p class="simple-grid-design date">' . get_the_date("M j, Y") . "</p>";
                $output .= '<a class="simple-grid-design title" href="' . get_permalink() . '" target="_blank">' . get_the_title() . "</a>";
                $output .= "</div>";
                $count++;
                if ($count == $columns || $recent_posts_query->current_post + 1 == $recent_posts_query->post_count)
                {
