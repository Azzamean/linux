	...
	<div class="container main-content">
		...
		<div class="full-width-section">
            ...
            if ($projects_header == "Secondary Logo") {
				...
				if ($projects_header != "Logo" && $projects_header != "Secondary Logo") { ?>
					<h1 class="entry-title" style="color:#ffffff;"><?php the_title(); ?></h1>
					<?php
				} ?>
		<?php if ($projects_excerpt != null) { ?>
			<p class="projects-title-text <?php if ($projects_banner != null) {
			    echo 'white">';
			} else {
			    echo '">';
			} ?> 
			<?php echo $projects_excerpt; ?> </p>
			<?php
		} ?>
				</div>
			</div>
						...
						<?php if (have_rows("projects_icon_urls")):
						    while (have_rows("projects_icon_urls")):
						        ...
						        if (get_row_layout() == "projects_add_icon_url"):
						            ...
						            echo '<a class="projects-icon" href="' . $projects_url . '">' . $projects_icon . "</a>" . '<p><a href="' . $projects_url . '"</a>' . $projects_icon_name . "</p>";
						            echo "</div>";
						        endif;
						    endwhile;
						endif; ?>
