...
elseif ($category == "techstrongtv" || ($category == "making-our-strong-community-stronger-initiative" || $category == "tfir-partnership"))
{
...
$args = ['orderby' => $category, 'order' => 'ASC', "posts_per_page" => 5, 'category_name' => $category, 'post__not_in' => array(
    $post->ID
) ];
