...
{
    return ["Custom Fonts" => ["BwModelica-Bold" => "BwModelica-Bold", "BwModelica-BoldItalic" => "BwModelica-BoldItalic", "BwModelica-ExtraBold" => "BwModelica-ExtraBold", "BwModelica-ExtraBoldItalic" => "BwModelica-ExtraBoldItalic", "BwModelica-Light" => "BwModelica-Light", "BwModelica-LightItalic" => "BwModelica-LightItalic", "BwModelica-Medium" => "BwModelica-Medium", "BwModelica-MediumItalic" => "BwModelica-MediumItalic", "BwModelica-Regular" => "BwModelica-Regular", "BwModelica-RegularItalic" => "BwModelica-RegularItalic", "BwModelicaSS02-Regular" => "BwModelicaSS02-Regular", "BwModelicaSS02-RegularItalic" => "BwModelicaSS02-RegularItalic", ], ];
}
