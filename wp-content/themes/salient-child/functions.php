...
// AUOTMATICALLY CHECK THE BOX SO USER IS NOT EMAILED FOR CONFIRMATION
add_action('admin_enqueue_scripts', function() {
        if (! is_multisite() || 'user' !== (get_current_screen())->id) {
            return;
        }
...
// ADD IN THE SKIP EMAIL CONFIRMATION FOR ADMIN USERS
